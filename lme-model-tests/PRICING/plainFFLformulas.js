...
FES_COLUMN_VISIBLE_value=undefined;
...
Facility_tpWeightedAmountRepayment_value=undefined;
Facility_tpWeightedAmountRepayment_trend=Facility_tpRepayment*Facility_tpHulpVarWeightOfRepayment;
Facility_tpWeightedAmountRepayment_title='Weighted Repayment Amount';
Facility_tpWeightedAmountRepaymentRem_value=undefined;
Facility_tpWeightedAmountRepaymentRem_trend=Facility_tpRepayment*Facility_tpHulpVarWeightOfRepaymentRemaining;
Facility_tpWeightedAmountRepaymentRem_title='Weighted Repayment Amount Remaining';
Facility_tpWithdrawal_value=undefined;
Facility_tpWithdrawal_notrend=If(Facility_tpWithdrawalChoice==0,Facility_tpWithdrawalOneTime,If(Facility_tpWithdrawalChoice==1,Facility_tpWithdrawalFixedTerms,If(Facility_tpWithdrawalChoice==2,Facility_tpWithdrawalRevolving,If(Facility_tpWithdrawalChoice==3,Facility_tpWithdrawalsAmount,NA))));
Facility_tpWithdrawal_title='Withdrawal';
Facility_tpRepayment_value=undefined;
Facility_tpRepayment_trend=If(Facility_tpRepaymentChoice==0||Facility_tpRepaymentChoice==4,Facility_tpRepaymentBalloon,If(Facility_tpRepaymentChoice==1,Facility_tpRepaymentLinear+Facility_tpRepaymentBalloon,If(Facility_tpRepaymentChoice==2,Facility_tpRepaymentAnnuity+Facility_tpRepaymentBalloon,If(Facility_tpRepaymentChoice==3,If(T==DateToT(Facility_tpEndDateMax10,1),Facility_tpOutstandingBalance[GetT(T,-1)],Facility_tpRepaymentsAmount[GetT(T,-1)])))));
Facility_tpRepayment_title='Repayment';
Facility_tpOutstandingBalance_value=undefined;
Facility_tpOutstandingBalance_notrend=Facility_tpWithdrawal-Facility_tpRepayment;
Facility_tpOutstandingBalance_trend=OnNeg(OnZero(HSum(Facility_tpWithdrawal,DateToT(Facility_tpStartDate,1),T)-HSum(Facility_tpRepayment,DateToT(Facility_tpStartDate,1),T),NA),NA);
Facility_tpOutstandingBalance_title='Outstanding Balance';
Facility_tpOutstandingBalanceHulpVar_value=undefined;
Facility_tpOutstandingBalanceHulpVar_trend=If(Facility_tpRepaymentChoice==0,Facility_tpOutstandingBalance,If(Facility_tpHulpVarFrequency<Facility_tpHulpVarFrequency[GetT(T,1)],Facility_tpOutstandingBalance,Facility_tpOutstandingBalance*NA));
Facility_tpOutstandingBalanceHulpVar_title='Outstanding Balance Hulp Average calculation';
Facility_tpHulpVarFrequency_value=undefined;
Facility_tpHulpVarFrequency_trend=If(T>DateToT(Facility_tpEndDateMax10,1),NA,If(T==DateToT(Facility_tpEndDateMax10,1),Facility_tpHulpVarFrequency[GetT(T,-1)]+1,Round((T-DateToT(Facility_tpStartDate,1)-Facility_tpGracePeriod)/(TsY/Facility_tpRepaymentFrequency)+.5,0)-1));
Facility_tpHulpVarFrequency_title='Hulp Var Tenors';
Facility_tpWithdrawalOneTime_value=undefined;
Facility_tpWithdrawalOneTime_trend=If(DateToT(Facility_tpStartDate,1)==T,Facility_tpPrincipalLimit,NA);
...
Facility_tpWithdrawalRevolving_value=undefined;
Facility_tpWithdrawalRevolving_notrend=NA;
...
Facility_tpRepaymentLinear_value=undefined;
Facility_tpRepaymentLinear_trend=If(Facility_tpAfterGraceperiod,OnZero(Min((Facility_tpHulpVarRepayment[GetT(T,-1)]!=Facility_tpHulpVarRepayment)*((Facility_tpPrincipalLimit-Facility_tpBalloon)/Facility_tpNumberOfPeriods),Facility_tpOutstandingBalance[GetT(T,-1)]),NA),NA);
Facility_tpRepaymentLinear_title='Repayment Scheme Linear';
Facility_tpRepaymentAnnuity_value=undefined;
Facility_tpRepaymentAnnuity_trend=If(Facility_tpAfterGraceperiod,If(Facility_tpHulpVarRepayment[GetT(T,-1)]!=Facility_tpHulpVarRepayment,(Facility_tpHulpVarRepayment[GetT(T,-1)]!=Facility_tpHulpVarRepayment)*PPMT(Facility_tpAnnuityInterestRate/Facility_tpRepaymentFrequency,Facility_tpHulpVarRepayment,Facility_tpNumberOfPeriods,-Facility_tpPrincipalLimit,Facility_tpBalloon),NA),NA);
Facility_tpRepaymentAnnuity_title='Repayment Scheme Annuity';
Facility_tpRepaymentBalloon_value=undefined;
Facility_tpRepaymentBalloon_trend=If(T==DateToT(Facility_tpEndDateMax10,1),If(Facility_tpRepaymentChoice==0,Facility_tpOutstandingBalance[GetT(T,-1)],If(Facility_tpRepaymentChoice==1||Facility_tpRepaymentChoice==2,Facility_tpOutstandingBalance[GetT(T,-1)]-If(Facility_tpRepaymentChoice==1,Facility_tpRepaymentLinear,If(Facility_tpRepaymentChoice==2,Facility_tpRepaymentAnnuity,NA)),NA)));
...
Facility_tpAfterGraceperiod_value=undefined;
Facility_tpAfterGraceperiod_trend=If(T<DateToT(Facility_tpStartDate,1)||T>DateToT(Facility_tpEndDateMax10,1),NA,If(T>=DateToT(AddMonth(Facility_tpStartDate,Facility_tpGracePeriod),1),1,0));
Facility_tpAfterGraceperiod_title='After Grace period (Y/N)';
Facility_tpHulpVarRepayment_value=undefined;
Facility_tpHulpVarRepayment_trend=If(T>DateToT(Facility_tpEndDateMax10,1)+1,NA,OnNeg(OnZero(Min(Round((T-DateToT(Facility_tpStartDate,1)-Facility_tpGracePeriod)/(TsY/Facility_tpRepaymentFrequency)+.5,0)-1,Facility_tpOutstandingBalance[GetT(T,-1)]),NA),NA));
Facility_tpHulpVarRepayment_title='Repayment At A Certain Time';
Facility_tpHulpVarRemainingWeighted_value=undefined;
Facility_tpHulpVarRemainingWeighted_trend=If(T>=DateToT(Facility_tpCurrentDate,1)+If(DateToDay(Facility_tpCurrentDate)==1,0,1)&&T>DateToT(Facility_tpStartDate,1)+Facility_tpGracePeriod,OnNeg(OnZero(Min(Round((T-If(DateToT(Facility_tpCurrentDate,1)+If(DateToDay(Facility_tpCurrentDate)==1,0,1)>DateToT(Facility_tpStartDate,1)+Facility_tpGracePeriod,DateToT(Facility_tpCurrentDate,1)+If(DateToDay(Facility_tpCurrentDate)==1,0,1),DateToT(Facility_tpStartDate,1)+Facility_tpGracePeriod+1))/(TsY/Facility_tpRepaymentFrequency)+.5,0),Facility_tpOutstandingBalance[GetT(T,-1)]),NA),NA),NA);
Facility_tpHulpVarRemainingWeighted_title='Repayment Term for weighted remaining tenor';
Facility_tpHulpVarWeightOfRepayment_value=undefined;
Facility_tpHulpVarWeightOfRepayment_trend=If(T>DateToT(Facility_tpEndDateMax10,1)||T<DateToT(Facility_tpStartDate,1),NA,T-DateToT(Facility_tpStartDate,1));
Facility_tpHulpVarWeightOfRepayment_title='Weight of repayment Original Tenor';
Facility_tpHulpVarWeightOfRepaymentRemaining_value=undefined;
Facility_tpHulpVarWeightOfRepaymentRemaining_trend=If(T>DateToT(Facility_tpEndDateMax10,1)||T<DateToT(If(Facility_tpCurrentDate<=Facility_tpStartDate,Facility_tpStartDate,Facility_tpCurrentDate),1),NA,T-DateToT(If(Facility_tpCurrentDate<=Facility_tpStartDate,Facility_tpStartDate,Facility_tpCurrentDate),1));
Facility_tpHulpVarWeightOfRepaymentRemaining_title='Weight of repayment Remaining Tenor';
Facility_tpHulpVarRepaymentScheme_value=undefined;
Facility_tpHulpVarRepaymentScheme_trend=If(Facility_tpRepaymentChoice==3&&Facility_tpRepayment!=NA,T-DateToT(Facility_tpStartDate,1),NA);
Facility_tpHulpVarRepaymentScheme_title='Repayment At A Certain Time via Scheme';
Facility_tpHulpVarRepaymentSchemeWeighted_value=undefined;
Facility_tpHulpVarRepaymentSchemeWeighted_trend=If(Facility_tpRepaymentChoice==3&&Facility_tpRepayment!=NA,If(T>=DateToT(Facility_tpCurrentDate,1)+If(DateToDay(Facility_tpCurrentDate)==1,0,1)&&T>DateToT(Facility_tpStartDate,1)+Facility_tpGracePeriod,T-DateToT(Facility_tpCurrentDate,1),NA),NA);
