 ...
 */
import { FFLToRegister as Formatter } from './FFLToRegister'
...
ChangeManager.prototype.updateCursor = function(ffl, cursor) {
	...
	if ((this.changed || changedCurrentVariable) && currentVariable && this.namedIndex[currentVariable]) {
		...
		this.currentVariable = this.register.createInformationObject(this.currentVariableName, new RegisterToFFL(this.register).hiddenProperties)
	}
	this.changed = false
}
