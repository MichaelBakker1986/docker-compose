...
Build unit test around PropertiesAssembler, its most unstable part of the APP
...
-PropertiesAssembler (kinda like variables, collection of properties and pointers to functions)
