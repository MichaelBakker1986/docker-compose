...
assert.equal('String(If(Q_Map01 == 0.0 , "Nog niet alle vragen zijn beantwoord.", "") + scRestricties + Q_WARNING_GLOBAL);', FflToJsonConverter.parseRegex('EvaluateAsString(If(Q_Map01 = 0.0, &"Nog niet alle vragen zijn beantwoord.", "") & scRestricties & Q_WARNING_GLOBAL);'));
