...
const info = {
    "\\("             : 'Open tag',
    link              : '(not ducumented yet) Links a variable to another',
    or                : 'a or b\nExample: true or fale = true',
...
const functions = {
    "balance"                                 : "Balance",
    "button-close"                            : "Close",
    "button-edit-upload"                      : "Change File",
    "button-reload-page"                      : "Reload page",
    "cancel"                                  : "Cancel",
    "code"                                    : "Code",
    "connection-back-to-login"                : "Return to login page.",
    "connection-lost-with-server-modal"       : "Connection with the server couldn't be restored. Check your internet connection and try to relog.",
    "connection-problem"                      : "There are connection problems with the server. Check your internet connection.",
    "connection-restore-failed"               : "Reconnecting failed",
    "connection-restored"                     : "Connection with the server has been restored.",
    "connection-retry-button"                 : "Retry connection",
    "connection-retry-next-timer"             : "Your login session will expire in ~ seconds if the connection with the server is not restored. You will be logged off.",
    "delete"                                  : "Delete",
    "description_remove_mapping"              : "Are you sure you want to delete the entire mapping?",
    "description"                             : "Description",
    "download_intermediate_results"           : "Download intermediate results",
    "dummy_ledger_account"                    : "Don't map",
    "fesbusy-busy"                            : "Processing",
    "fesbusy-idle"                            : "Saved",
    "fesbusy-undo-temp-disabled"              : "Undo is currently unavailable, retry again after calculations.",
    "file_upload_success"                     : "is uploaded successfully.",
    "formula_OnER_explanation"                : "An error has occurred while calculating the formula",
    "formula_OnERorNA_explanation"            : "An error has occured or a calculation did not result in a value",
    "formula_OnERorNA_explanation"            : "An error has occured or a calculation did not result in a value",
    "formula_OnNA_explanation"                : "A necessary value was not filled",
    "formula_OnNeg_explanation"               : "A value that was not supposed to be negative, was negative",
    "formula_OnZero_explanation"              : "A value that is not supposed to be zero, was zero",
    "formula_OnZeroOrNA_explanation"          : "The result of a calculation was zero or the calculation did not result in a value",
    "formula-viewer_explanation_example"      : "Example",
    "formula-viewer_explanation_functionname" : "Function name:",
    "formula-viewer_explanation_not_available": "Explanation of the function is not available.",
    "abs"                                     : "Abs(-100) Returns 100|Returns the absolute value of expression.",
    "activescriptname"                        : "|Not available",
    "activetopvarname"                        : "|Not available",
    "activevarname"                           : "|Not available",
    ...
    "formula-viewer_result"                   : "Result",
    "formula-viewer_secret"                   : "This formula contains protected information and thus the formula cannot be shown.",
    "from_the"                                : "out of",
    "header_remove_mapping"                   : "Remove mapping",
    "journalcode"                             : "ledger account code",
    "loading"                                 : "Loading",
    "mapped"                                  : "Mapped",
    "mapping_invalid_columns"                 : "doesnt have enough columns. Minimum of three columns are needed.",
    "mapping_invalid_data"                    : "data could not be read. It might not be a valid CSV data structure.",
    "mapping_no_mapped_results"               : "No mapped accounts found in import data.",
    "mapping_no_unmapped_results"             : "All accounts are mapped.",
    "no_results_found"                        : "No results found",
    "no_results"                              : "No results",
    "not_valid_csv_file"                      : "is not a CSV file format.",
    "number_of_accounts_found"                : "Accounts found",
    "popover-info-title"                      : "Information",
    "search_records"                          : "Search",
    "session_expired_message"                 : "Your session has expired because of inactivity. Reload the page to log in again.",
    "session-back-to-login"                   : "Log in again",
    "session-continue-button"                 : "Continue",
    "session-continue-timer"                  : "You will be signed out in ~ seconds.",
    "session-continue"                        : "Do you want to continue?",
    "session-expired"                         : "Your session has expired",
    "session-expires"                         : "Session expires",
    "session-logout-button"                   : "Log out"
}
const highlights = {
...
FormulaInformationManager.prototype.extractParts = function(workbook, info) {
    return info.parts.map(function(formulaAsString, idx) {
        ...
        const e_value = workbook.get('SMT', 'a' + idx)
        console.info(formulaAsString + "=" + e_value)
        return [formulaAsString, e_value].join('=')
    })
}
