...
FPS_VAR_Rechtsvorm_nr_value='';
FPS_VAR_Rechtsvorm_nr_title='LEGALSTATUSCODE';
FPS_VAR_Rechtsvorm_omschr_value='';
...
Q_MAP01_WARNING_visible=Q_MAP01.visible&&Length(Q_MAP01_WARNING);
Q_MAP01_INFO_value='';
Q_MAP01_INFO_title='Info bij stap';
Q_MAP01_INFO_visible=Q_MAP01.visible&&Length(Q_MAP01_INFO);
...
Q_MAP01_VALIDATION_visible=Q_MAP01.visible&&Length(Q_MAP01_VALIDATION);
Agreement_value=undefined;
Agreement_title='Agreement';
AgreementSub1_value='';
AgreementSub1_title='Agreement';
AgreementIdentifier_value='';
...
AgreementHiddenfields_value='';
AgreementHiddenfields_title='Hidden fields for calculations';
AgreementHiddenfields_visible=Agreement.visible&&ShowTestVariables;
AgreementNumber_value='';
AgreementNumber_title='Agreement';
...
Borrower_tpBaseCurrency_visible=Borrower_tpInput.visible&&0;
...
Borrower_tpClientGroup_visible=Borrower_tpInput.visible&&ShowTestVariables;
...
Borrower_tpAGICChoice_visible=Borrower_tpInput.visible&&Borrower_tpAGICOrSBI==0;
...
Borrower_tpDataImportedFromForce_value='';
Borrower_tpDataImportedFromForce_title=String('Imported Data');
Borrower_tpDataImportedFromForce_visible=Borrower.visible&&ShowTestVariables;
...
Borrower_tpSBI_visible=Borrower_tpDataImportedFromForce.visible&&Borrower_tpAGICOrSBI==1;
Borrower_tpPDModel_value='';
Borrower_tpPDModel_title='PD Model';
Borrower_tpAutomaticInput_value='';
...
Borrower_tpClientGroupFullName_title='Client Group';
...
Borrower_tpSBIName_visible=Borrower_tpAutomaticInput.visible&&Borrower_tpAGICOrSBI==1;
...
Borrower_tpHiddenVariablesBorrowerInformation_visible=Borrower_tpAutomaticInput.visible&&0;
...
Borrower_tpAGICChoiceName_value='';
Borrower_tpAGICChoiceName_title='AGIC Sector Description';
Borrower_tpProfitAndLossClient_value='';
...
Borrower_tpIndirectLiquidityCosts_title='Indirect Liquidity Costs';
...
Borrower_tpInternalExpectedLoss_title='Internal Expected Loss';
...
Borrower_tpReturnOnEquity_title='Return On Equity';
...
Borrower_tpEconomicProfit_title='Economic Profit';
Borrower_tpEconomicProfitSub1_value=undefined;
Borrower_tpEconomicProfitSub1_title='Risk Adjusted Return';
...
Borrower_tpCrossSellProfitAndLossClient_value='';
...
Borrower_tpCrossSellIncome_title='Revenues';
Borrower_tpCrossSellIndirectLiquidityCosts_value=0;
Borrower_tpCrossSellIndirectLiquidityCosts_title='Indirect Liquidity Costs';
Borrower_tpCrossSellDirectLiquidityPremium_value=0;
Borrower_tpCrossSellDirectLiquidityPremium_title='Direct Liquidity Premium';
...
Borrower_tpCrossSellSubordinatedDebtCapitalCharge_title='Subordinated Debt Capital Charge';
...
Borrower_tpCrossSellRiskAdjustedReturn_title='Risk Adjusted Return';
...
Borrower_tpCrossSellRegulatoryProfit_title='Regulatory Profit';
Borrower_tpCrossSellEquityCapitalCharge_value=OnNA(TupleSum(Borrower_tpNonCredit_tpEquityCapitalCharge),0);
Borrower_tpCrossSellEquityCapitalCharge_title='Equity Capital Charge';
...
Borrower_tpCrossSellEconomicProfit_title='Economic Profit';
Borrower_tpCrossSellEconomicProfitSub1_value=undefined;
Borrower_tpCrossSellEconomicProfitSub1_title='Risk Adjusted Return';
Borrower_tpCrossSellCostOfEconomicCapital_value=Borrower_tpCrossSellEconomicCapital*Borrower_tpEffectiveCostOfCapital;
Borrower_tpCrossSellCostOfEconomicCapital_title='Cost of Economic Capital';
Borrower_tpCrossSellCostOfEconomicCapitalSub1_value=undefined;
Borrower_tpCrossSellCostOfEconomicCapitalSub1_title='Economic Capital';
Borrower_tpCrossSellCostOfEconomicCapitalSub2_value=undefined;
Borrower_tpCrossSellCostOfEconomicCapitalSub2_title='Effective Cost of Capital';
Borrower_tpCrossSellOtherMetrics_value='';
Borrower_tpCrossSellOtherMetrics_title='Other Metrics';
Borrower_tpCrossSellRWA_value=OnNA(Borrower_tpCrossSellRWAOperationalRisk,0);
Borrower_tpCrossSellRWA_title='RWA';
Borrower_tpCrossSellRWAOperationalRisk_value=OnNA(TupleSum(Borrower_tpNonCredit_tpRWAORNonCredit),0);
Borrower_tpCrossSellRWAOperationalRisk_title='RWA Operational Risk';
...
Borrower_tpClientProfitAndLossClient_value='';
...
Borrower_tpClientIncome_title='Revenues';
Borrower_tpClientInterestIncome_value=Borrower_tpInterestIncome;
Borrower_tpClientInterestIncome_title='Interest income';
Borrower_tpClientCreditRelatedFee_value=Borrower_tpCreditRelatedFee;
Borrower_tpClientCreditRelatedFee_title='Credit related fees';
...
Borrower_tpClientIndirectLiquidityCosts_title='Indirect Liquidity Costs';
Borrower_tpClientPrepaymentCosts_value=Borrower_tpPrepaymentCosts;
Borrower_tpClientPrepaymentCosts_title='Prepayment Costs';
Borrower_tpClientPipelineRisk_value=Borrower_tpPipelineRisk;
Borrower_tpClientPipelineRisk_title='Pipeline Risk';
...
Borrower_tpClientDirectLiquidityPremium_title='Direct Liquidity Premium';
...
Borrower_tpClientSubordinatedDebtCapitalCharge_title='Subordinated Debt Capital Charge';
...
Borrower_tpClientEquityFundingAdjustment_title='Equity Funding Adjustment';
Borrower_tpClientOperationalCosts_value=Borrower_tpOperationalCosts+Borrower_tpCrossSellOperationalCosts;
Borrower_tpClientOperationalCosts_title='Operational Costs';
Borrower_tpClientCostPerServiceConcept_value=Borrower_tpCostPerServiceConcept;
Borrower_tpClientCostPerServiceConcept_title='Cost per Service Concept';
Borrower_tpClientCostPerContract_value=Borrower_tpCostPerContract;
Borrower_tpClientCostPerContract_title='Cost per Contract';
...
Borrower_tpClientReturnOnEquity_title='Return On Equity';
...
Borrower_tpClientEconomicProfit_title='Economic Profit';
Borrower_tpClientEconomicProfitSub1_value=undefined;
Borrower_tpClientEconomicProfitSub1_title='Risk Adjusted Return';
Borrower_tpClientCostOfEconomicCapital_value=Borrower_tpClientEconomicCapital*Borrower_tpEffectiveCostOfCapital;
Borrower_tpClientCostOfEconomicCapital_title='Cost of Economic Capital';
Borrower_tpClientCostOfEconomicCapitalSub1_value=undefined;
Borrower_tpClientCostOfEconomicCapitalSub1_title='Economic Capital';
Borrower_tpClientCostOfEconomicCapitalSub2_value=undefined;
Borrower_tpClientCostOfEconomicCapitalSub2_title='Effective Cost of Capital';
Borrower_tpClientOtherMetrics_value='';
Borrower_tpClientOtherMetrics_title='Other Metrics';
Borrower_tpClientPrincipalLimit_value=Borrower_tpPrincipalLimit;
Borrower_tpClientPrincipalLimit_title='Principal Limit';
Borrower_tpClientOutstanding_value=Borrower_tpExpectedAverageOutstanding;
Borrower_tpClientOutstanding_title='ExpectedAverageOutstanding';
Borrower_tpClientRWA_value=Borrower_tpRWA+Borrower_tpCrossSellRWA;
Borrower_tpClientRWA_title='RWA';
Borrower_tpClientRWACreditRisk_value=Borrower_tpRWACreditRisk;
Borrower_tpClientRWACreditRisk_title='RWA Credit Risk';
Borrower_tpClientRWAOperationalRisk_value=Borrower_tpRWAOperationalRisk+Borrower_tpCrossSellRWAOperationalRisk;
Borrower_tpClientRWAOperationalRisk_title='RWA Operational Risk';
Borrower_tpClientEAD_value=Borrower_tpEAD;
Borrower_tpClientEAD_title='EAD';
Borrower_tpClientNonCreditNetIncome_Total_value=Borrower_tpCrossSellNonCreditNetIncome_Total;
Borrower_tpClientNonCreditNetIncome_Total_title='Total Non Credit Net Income';
Borrower_tpClientHiddenVariables_value=undefined;
Borrower_tpClientHiddenVariables_title='Hidden variables voor P/L Compact Report';
Borrower_tpClientHiddenVariables_visible=Borrower_tpClientProfitAndLossClient.visible&&0;
...
Borrower_tpClientTaxAndOther_title='Tax&&Other';
Borrower_tpNonCredit_value='';
Borrower_tpNonCredit_title='A Cross Sell item';
Borrower_tpNonCredit_tpDataImportedFromForce_value='';
Borrower_tpNonCredit_tpDataImportedFromForce_title=String('Imported Data for Cross Sell Items');
Borrower_tpNonCredit_tpDataImportedFromForce_visible=Borrower_tpNonCredit.visible&&ShowTestVariables;
...
Borrower_tpNonCredit_tpIncome_ClientGroup_value='';
...
Borrower_tpNonCredit_tpEquityCapitalCharge_title='Equity Capital Charge';
Facility_value='';
Facility_title='Facility';
Facility_tpDataForUserView_value='';
Facility_tpDataForUserView_title=String('Data for UserView');
Facility_tpDataForUserView_visible=Facility.visible&&ShowTestVariables;
...
Facility_tpEconomicProfit_title='Economic Profit';
...
Facility_tpCostOfEconomicCapital_title='Cost of Economic Capital';
Facility_tpCostOfEconomicCapital_hint='The outcome will be multiplied by the fraction of the remaining average tenor when < 1 year';
...
Facility_tpRegulatoryProfit_title='Regulatory Profit';
Facility_tpOtherMetrics_value=undefined;
Facility_tpOtherMetrics_title='Other Metrics';
Facility_tpRequiredInput_value='';
...
Facility_tpBaseCurrency_visible=Facility_tpRequiredInput.visible&&ShowTestVariables;
...
Facility_tpFixedInterestPeriod_title='Fixed Interest Period';
...
Facility_tpOfferPeriodChoice_hint='Default is set to two weeks';
...
Facility_tpDataImportedFromForce_value='';
Facility_tpDataImportedFromForce_title=String('Imported Data');
Facility_tpType_value='';
Facility_tpType_title='Abbreviated Facility Type';
Facility_tpID_value='';
Facility_tpID_title='Accountnumber';
Facility_tpStatusName_value='';
Facility_tpStatusName_title='Status';
Facility_tpProductReferenceNumber_value='';
...
Facility_tpProductuptakeDetailsUptakeType_value='';
Facility_tpProductuptakeDetailsUptakeType_title='Withdrawal - WithdrawalType';
Facility_tpProductuptakeDetailsUptakeType_hint='ONE_TIME,FIXED_TERMS,REVOLVING,IRREGULAR_SCHEDULE';
Facility_tpProductuptakeDetailsUptakeFrequency_value='';
Facility_tpProductuptakeDetailsUptakeFrequency_title='Withdrawal - WithdrawalFrequency';
Facility_tpProductuptakeDetailsUptakeFrequency_hint='Daily, WEEKLy,MONTHLY,Quarterly,YEARLY';
Facility_tpProductWithdrawalDetailsLastPossibleWithdrawalDate_value='';
Facility_tpProductWithdrawalDetailsLastPossibleWithdrawalDate_title='Withdrawal - Last Possible Withdrawal Date';
Facility_tpProductWithdrawalDetailsLastPossibleWithdrawalDate_hint='Can only be specified with choosing to withdraw at once';
...
Facility_tpProductredemptionDetailsFirstRedemptionAfterXMonths_value='';
...
Facility_tpInterestProductCode_hint='This code is used to retrieve the right liquidity spread';
...
Facility_tpProductinterestDetailsFixedInterestPeriod_hint='Period in months';
...
Facility_tpAutomaticInput_value='';
...
Facility_tpBorrower_tpPLorNPL_title='PL / NPL account';
Facility_RepaymentScheme_value='';
...
Facility_tpOriginalAverageTenorTHsum_visible=Facility_RepaymentScheme.visible&&ShowTestVariables;
...
Facility_tpRemainingAverageTenor2_title='Remaining Average Tenor (Years)';
...
Facility_tpEndDate_title='End date';
...
Facility_tpExpectedAverageOutstanding2_title='Expected Average Outstanding (For upcoming 12 months after Current Date)';
Facility_RepaymentSchemeSub26_value='';
...
Facility_RepaymentSchemeSub28_value='';
Facility_RepaymentSchemeSub28_title='Tuples Manual Scheme';
Facility_tpManual_value='';
Facility_tpManual_title='Manual Scheme';
Facility_tpManual_tpMonthIdentifier_value='';
...
Facility_tpManual_tpMonthsSinceStartDate_hint='This variabele is based on months - depending time frequency';
...
Facility_tpManual_tpLiquiditySpreadBpsTRepayment_value='MatrixLookup(\'AAB_Parameters.xls\',If(Facility_tpBaseCurrency==\'EUR\',\'LiquidityPremiumEUR\',If(Facility_tpBaseCurrency==\'GBP\',\'LiquidityPremiumGBP\',If(Facility_tpBaseCurrency==\'USD\',\'LiquidityPremiumUSD\',\'LiquidityPremiumOther\'))),MatrixLookup(\'LiquidityPremiumTenorLowerBound\',Facility_tpManual_tpMonthsSinceStartDate,1),Facility_tpFixedInterestPeriod)+(MatrixLookup(\'AAB_Parameters.xls\',If(Facility_tpBaseCurrency==\'EUR\',\'LiquidityPremiumEUR\',If(Facility_tpBaseCurrency==\'GBP\',\'LiquidityPremiumGBP\',If(Facility_tpBaseCurrency==\'USD\',\'LiquidityPremiumUSD\',\'LiquidityPremiumOther\'))),MatrixLookup(\'LiquidityPremiumTenorUpperBound\',Facility_tpManual_tpMonthsSinceStartDate,1),Facility_tpFixedInterestPeriod)-MatrixLookup(\'AAB_Parameters.xls\',If(Facility_tpBaseCurrency==\'EUR\',\'LiquidityPremiumEUR\',If(Facility_tpBaseCurrency==\'GBP\',\'LiquidityPremiumGBP\',If(Facility_tpBaseCurrency==\'USD\',\'LiquidityPremiumUSD\',\'LiquidityPremiumOther\'))),MatrixLookup(\'LiquidityPremiumTenorLowerBound\',Facility_tpManual_tpMonthsSinceStartDate,1),Facility_tpFixedInterestPeriod))*OnER((Facility_tpManual_tpMonthsSinceStartDate-MatrixLookup(\'LiquidityPremiumTenorLowerBound\',Facility_tpManual_tpMonthsSinceStartDate,1))/(MatrixLookup(\'LiquidityPremiumTenorUpperBound\',Facility_tpManual_tpMonthsSinceStartDate,1)-MatrixLookup(\'LiquidityPremiumTenorLowerBound\',Facility_tpManual_tpMonthsSinceStartDate,1)),0)';
...
Facility_tpManual_tpLiquiditySpreadBpsTWithdrawal_value='MatrixLookup(\'AAB_Parameters.xls\',If(Facility_tpBaseCurrency==\'EUR\',\'LiquidityPremiumEUR\',If(Facility_tpBaseCurrency==\'GBP\',\'LiquidityPremiumGBP\',If(Facility_tpBaseCurrency==\'USD\',\'LiquidityPremiumUSD\',\'LiquidityPremiumOther\'))),MatrixLookup(\'LiquidityPremiumTenorLowerBound\',Facility_tpManual_tpMonthsSinceStartDate-1,1),Facility_tpFixedInterestPeriod)+(MatrixLookup(\'AAB_Parameters.xls\',If(Facility_tpBaseCurrency==\'EUR\',\'LiquidityPremiumEUR\',If(Facility_tpBaseCurrency==\'GBP\',\'LiquidityPremiumGBP\',If(Facility_tpBaseCurrency==\'USD\',\'LiquidityPremiumUSD\',\'LiquidityPremiumOther\'))),MatrixLookup(\'LiquidityPremiumTenorUpperBound\',Facility_tpManual_tpMonthsSinceStartDate-1,1),Facility_tpFixedInterestPeriod)-MatrixLookup(\'AAB_Parameters.xls\',If(Facility_tpBaseCurrency==\'EUR\',\'LiquidityPremiumEUR\',If(Facility_tpBaseCurrency==\'GBP\',\'LiquidityPremiumGBP\',If(Facility_tpBaseCurrency==\'USD\',\'LiquidityPremiumUSD\',\'LiquidityPremiumOther\'))),MatrixLookup(\'LiquidityPremiumTenorLowerBound\',Facility_tpManual_tpMonthsSinceStartDate-1,1),Facility_tpFixedInterestPeriod))*OnER((Facility_tpManual_tpMonthsSinceStartDate-1-MatrixLookup(\'LiquidityPremiumTenorLowerBound\',Facility_tpManual_tpMonthsSinceStartDate-1,1))/(MatrixLookup(\'LiquidityPremiumTenorUpperBound\',Facility_tpManual_tpMonthsSinceStartDate-1,1)-MatrixLookup(\'LiquidityPremiumTenorLowerBound\',Facility_tpManual_tpMonthsSinceStartDate-1,1)),0)';
...
Facility_tpExpectedAverageOutstandingScheme_title='Expected Average Outstanding';
Facility_tpAnnuityLinear_value='';
Facility_tpAnnuityLinear_title='Annuity + Linear';
Facility_tpAnnuityParameters_value='';
...
Facility_tpAnnuityLinearSub11_value='';
...
Facility_tpAnnuityOATHelpVarWeightSumGrace_value='';
...
Facility_tpLinearWithdrawal_value='';
...
Facility_tpEAORepaymentLinearForSchemeWithdrawal_title='Linear Outstanding Repayment Sum';
...
Facility_tpHiddenRepaymentScheme_visible=Facility_RepaymentScheme.visible&&0;
Facility_tpWeightedAmountRepayment_value=x.istrend?Facility_tpRepayment*Facility_tpHulpVarWeightOfRepayment:undefined;
Facility_tpWeightedAmountRepayment_title='Weighted Repayment Amount';
Facility_tpWeightedAmountRepaymentRem_value=x.istrend?Facility_tpRepayment*Facility_tpHulpVarWeightOfRepaymentRemaining:undefined;
...
Facility_tpRepayment_value=x.istrend?If(Facility_tpRepaymentChoice==0||Facility_tpRepaymentChoice==4,Facility_tpRepaymentBalloon,If(Facility_tpRepaymentChoice==1,Facility_tpRepaymentLinear+Facility_tpRepaymentBalloon,If(Facility_tpRepaymentChoice==2,Facility_tpRepaymentAnnuity+Facility_tpRepaymentBalloon,If(Facility_tpRepaymentChoice==3,If(T==DateToT(Facility_tpEndDateMax10,1),Facility_tpOutstandingBalance[prev],Facility_tpRepaymentsAmount[prev]))))):undefined;
Facility_tpRepayment_title='Repayment';
Facility_tpOutstandingBalance_value=x.istrend?OnNeg(OnZero(HSum(Facility_tpWithdrawal,DateToT(Facility_tpStartDate,1),T)-HSum(Facility_tpRepayment,DateToT(Facility_tpStartDate,1),T),NA),NA):Facility_tpWithdrawal-Facility_tpRepayment;
Facility_tpOutstandingBalance_title='Outstanding Balance';
Facility_tpOutstandingBalanceHulpVar_value=x.istrend?If(Facility_tpRepaymentChoice==0,Facility_tpOutstandingBalance,If(Facility_tpHulpVarFrequency<Facility_tpHulpVarFrequency[GetT(T,1)],Facility_tpOutstandingBalance,Facility_tpOutstandingBalance*NA)):undefined;
Facility_tpOutstandingBalanceHulpVar_title='Outstanding Balance Hulp Average calculation';
Facility_tpHulpVarFrequency_value=x.istrend?If(T>DateToT(Facility_tpEndDateMax10,1),NA,If(T==DateToT(Facility_tpEndDateMax10,1),Facility_tpHulpVarFrequency[prev]+1,Round((T-DateToT(Facility_tpStartDate,1)-Facility_tpGracePeriod)/(TsY/Facility_tpRepaymentFrequency)+.5,0)-1)):undefined;
Facility_tpHulpVarFrequency_title='Hulp Var Tenors';
Facility_tpWithdrawalOneTime_value=x.istrend?If(DateToT(Facility_tpStartDate,1)==T,Facility_tpPrincipalLimit,NA):undefined;
Facility_tpWithdrawalOneTime_title='Withdrawal One Time';
Facility_tpWithdrawalFixedTerms_value='';
Facility_tpWithdrawalFixedTerms_title='Withdrawal Fixed Terms';
Facility_tpWithdrawalRevolving_value=x.istrend?If(DateToT(Facility_tpStartDate,1)==T,Facility_tpPrincipalLimit,NA):NA;
Facility_tpWithdrawalRevolving_title='Withdrawal Revolving';
Facility_tpWithdrawalsAmount_value='';
Facility_tpWithdrawalsAmount_title='Withdrawals Scheme';
Facility_tpRepaymentLinear_value=x.istrend?If(Facility_tpAfterGraceperiod,OnZero(Min((Facility_tpHulpVarRepayment[prev]!=Facility_tpHulpVarRepayment)*((Facility_tpPrincipalLimit-Facility_tpBalloon)/Facility_tpNumberOfPeriods),Facility_tpOutstandingBalance[prev]),NA),NA):undefined;
Facility_tpRepaymentLinear_title='Repayment Scheme Linear';
Facility_tpRepaymentAnnuity_value=x.istrend?If(Facility_tpAfterGraceperiod,If(Facility_tpHulpVarRepayment[prev]!=Facility_tpHulpVarRepayment,(Facility_tpHulpVarRepayment[prev]!=Facility_tpHulpVarRepayment)*PPMT(Facility_tpAnnuityInterestRate/Facility_tpRepaymentFrequency,Facility_tpHulpVarRepayment,Facility_tpNumberOfPeriods,-Facility_tpPrincipalLimit,Facility_tpBalloon),NA),NA):undefined;
Facility_tpRepaymentAnnuity_title='Repayment Scheme Annuity';
Facility_tpRepaymentBalloon_value=x.istrend?If(T==DateToT(Facility_tpEndDateMax10,1),If(Facility_tpRepaymentChoice==0,Facility_tpOutstandingBalance[prev],If(Facility_tpRepaymentChoice==1||Facility_tpRepaymentChoice==2,Facility_tpOutstandingBalance[prev]-If(Facility_tpRepaymentChoice==1,Facility_tpRepaymentLinear,If(Facility_tpRepaymentChoice==2,Facility_tpRepaymentAnnuity,NA)),NA))):undefined;
Facility_tpRepaymentBalloon_title='Repayment Balloon';
Facility_tpRepaymentRevolving_value='';
...
Facility_tpAfterGraceperiod_value=x.istrend?If(T<DateToT(Facility_tpStartDate,1)||T>DateToT(Facility_tpEndDateMax10,1),NA,If(T>=DateToT(AddMonth(Facility_tpStartDate,Facility_tpGracePeriod),1),1,0)):undefined;
Facility_tpAfterGraceperiod_title='After Grace period (Y/N)';
Facility_tpHulpVarRepayment_value=x.istrend?If(T>DateToT(Facility_tpEndDateMax10,1)+1,NA,OnNeg(OnZero(Min(Round((T-DateToT(Facility_tpStartDate,1)-Facility_tpGracePeriod)/(TsY/Facility_tpRepaymentFrequency)+.5,0)-1,Facility_tpOutstandingBalance[prev]),NA),NA)):undefined;
Facility_tpHulpVarRepayment_title='Repayment At A Certain Time';
Facility_tpHulpVarRemainingWeighted_value=x.istrend?If(T>=DateToT(Facility_tpCurrentDate,1)+If(DateToDay(Facility_tpCurrentDate)==1,0,1)&&T>DateToT(Facility_tpStartDate,1)+Facility_tpGracePeriod,OnNeg(OnZero(Min(Round((T-If(DateToT(Facility_tpCurrentDate,1)+If(DateToDay(Facility_tpCurrentDate)==1,0,1)>DateToT(Facility_tpStartDate,1)+Facility_tpGracePeriod,DateToT(Facility_tpCurrentDate,1)+If(DateToDay(Facility_tpCurrentDate)==1,0,1),DateToT(Facility_tpStartDate,1)+Facility_tpGracePeriod+1))/(TsY/Facility_tpRepaymentFrequency)+.5,0),Facility_tpOutstandingBalance[prev]),NA),NA),NA):undefined;
Facility_tpHulpVarRemainingWeighted_title='Repayment Term for weighted remaining tenor';
Facility_tpHulpVarWeightOfRepayment_value=x.istrend?If(T>DateToT(Facility_tpEndDateMax10,1)||T<DateToT(Facility_tpStartDate,1),NA,T-DateToT(Facility_tpStartDate,1)):undefined;
Facility_tpHulpVarWeightOfRepayment_title='Weight of repayment Original Tenor';
Facility_tpHulpVarWeightOfRepaymentRemaining_value=x.istrend?If(T>DateToT(Facility_tpEndDateMax10,1)||T<DateToT(If(Facility_tpCurrentDate<=Facility_tpStartDate,Facility_tpStartDate,Facility_tpCurrentDate),1),NA,T-DateToT(If(Facility_tpCurrentDate<=Facility_tpStartDate,Facility_tpStartDate,Facility_tpCurrentDate),1)):undefined;
Facility_tpHulpVarWeightOfRepaymentRemaining_title='Weight of repayment Remaining Tenor';
Facility_tpHulpVarRepaymentScheme_value=x.istrend?If(Facility_tpRepaymentChoice==3&&Facility_tpRepayment!=NA,T-DateToT(Facility_tpStartDate,1),NA):undefined;
Facility_tpHulpVarRepaymentScheme_title='Repayment At A Certain Time via Scheme';
Facility_tpHulpVarRepaymentSchemeWeighted_value=x.istrend?If(Facility_tpRepaymentChoice==3&&Facility_tpRepayment!=NA,If(T>=DateToT(Facility_tpCurrentDate,1)+If(DateToDay(Facility_tpCurrentDate)==1,0,1)&&T>DateToT(Facility_tpStartDate,1)+Facility_tpGracePeriod,T-DateToT(Facility_tpCurrentDate,1),NA),NA):undefined;
Facility_tpHulpVarRepaymentSchemeWeighted_title='Repayment Term for weighted remaining tenor via Scheme';
Facility_tpDirectLiquidityPremiumPerT_value='';
Facility_tpDirectLiquidityPremiumPerT_title='Direct Liquidity Premium Per T';
Facility_tpFundingAmountPerT_value='';
Facility_tpFundingAmountPerT_title='Funding Amount Per T';
Facility_tpWeightedFundingAmountPerT_value='';
Facility_tpWeightedFundingAmountPerT_title='Funding Weighted Amount Per T';
Facility_tpPeriodPerT_value='';
Facility_tpPeriodPerT_title='Period of T into years';
Facility_tpLiquiditySpreadBpsT_value='';
...
Facility_tpGuarantor_value='';
Facility_tpGuarantor_title=String('Third party Guarantees');
Facility_tpGuarantorAGICOrSBI_value=0;
Facility_tpGuarantorAGICOrSBI_title='Do you want to use an AGIC || SBI identification code';
Facility_tpGuarantorSBI_value='';
Facility_tpGuarantorSBI_title='SBI branche code (Geen lijst)';
Facility_tpGuarantorSBIName_value=String(MatrixLookup('SBIMapping',''+Facility_tpGuarantorSBI,1));
Facility_tpGuarantorSBIName_title='SBI branche naam';
Facility_tpGuarantorAGICChoice_value=undefined;
Facility_tpGuarantorAGICChoice_title='AGIC Sector';
Facility_tpGuarantorAGIC_value='';
Facility_tpGuarantorAGIC_title='AGIC Code';
Facility_tpGuarantorAGIC_visible=Facility_tpGuarantor.visible&&ShowTestVariables;
...
Facility_tpGuarantorRatingChoice_title='UCR Rating';
...
Facility_tpGuarantorPDModelChoice_title='PD Model';
...
FacilitySub7Sub1Sub3_title='Risk Adjusted Return - Income';
...
FacilitySub7Sub9_title='Risk Adjusted Return';
FacilitySub7Sub10_value=undefined;
FacilitySub7Sub10_title='Return on Equity ()';
FacilitySub7Sub10Sub1_value=undefined;
FacilitySub7Sub10Sub1_title='Risk Adjusted Return';
FacilitySub7Sub10Sub2_value=undefined;
FacilitySub7Sub10Sub2_title='Return on Equity ()';
FacilitySub7Sub11_value=undefined;
FacilitySub7Sub11_title='RaRoRaC ()';
FacilitySub7Sub11Sub1_value=undefined;
FacilitySub7Sub11Sub1_title='Risk Adjusted Return';
FacilitySub7Sub11Sub2_value=undefined;
FacilitySub7Sub11Sub2_title='Economic Capital';
FacilitySub7Sub11Sub3_value=undefined;
FacilitySub7Sub11Sub3_title='RaRoRaC ()';
FacilitySub7Sub12_value='';
FacilitySub7Sub12_title='Regulatory Profit';
FacilitySub7Sub12Sub1_value=undefined;
FacilitySub7Sub12Sub1_title='Risk Adjusted Return';
FacilitySub7Sub12Sub2_value=undefined;
FacilitySub7Sub12Sub2_title='Regulatory Profit - Equity Capital Charge';
FacilitySub7Sub12Sub3_value='';
FacilitySub7Sub12Sub3_title='Regulatory Profit';
FacilitySub7Sub13_value='';
FacilitySub7Sub13_title='Economic Profit';
FacilitySub7Sub13Sub1_value=undefined;
FacilitySub7Sub13Sub1_title='Risk Adjusted Return';
FacilitySub7Sub13Sub2_value='';
FacilitySub7Sub13Sub2_title='Cost of Economic Capital';
FacilitySub7Sub13Sub2Sub1_value=undefined;
FacilitySub7Sub13Sub2Sub1_title='Economic Capital';
FacilitySub7Sub13Sub2Sub2_value=undefined;
FacilitySub7Sub13Sub2Sub2_title='Effective Cost of Economic Capital';
FacilitySub7Sub14_value=undefined;
FacilitySub7Sub14_title='Other Metrics';
FacilitySub7Sub14Sub1_value=undefined;
FacilitySub7Sub14Sub1_title='Facility Limit';
FacilitySub7Sub14Sub2_value=undefined;
FacilitySub7Sub14Sub2_title='Expected Average Outstanding (For upcoming 12 months after Current Date)';
FacilitySub7Sub14Sub3_value=undefined;
FacilitySub7Sub14Sub3_title='Risk Adjusted Return - Other Expenses - Internal Expected Loss';
...
FacilitySub7Sub14Sub5_title='Exposure At Default';
Facility_tpTargetRaRoRaCSection_value='';
Facility_tpTargetRaRoRaCSection_title='Target RaRoRaC';
...
Facility_tpEconomicCapital_title='Economic Capital';
Facility_tpOperationalRisk_value=Facility_tpORCreditRisk;
Facility_tpOperationalRisk_title='Economic Capital - Operational Risk';
...
Facility_tpBusinessRisk_title='Economic Capital - Business Risk';
...
Facility_tpCreditRisk_title='Economic Capital - Credit Risk';
...
Facility_tpEAD_title='Exposure At Default';
Facility_tpEADGeneral_value='';
...
Facility_tpEADUnguaranteedHR_hint='When the headroom is greater than 0 Euro. NB,  Negative values for UGD&&PGO are not used in this pricing tool';
...
Facility_tpEADUnguaranteedHRZero_hint='When the headroom is less than || equal to 0 Euro. NB,  Negative values for UGD&&PGO are not used in this pricing tool';
...
Facility_tpEADGuaranteedHR_title='Economic Capital - Credit Risk - Exposure At Default';
...
Facility_tpEADGuaranteedHRZero_title='Economic Capital - Credit Risk - Exposure At Default Zero Headroom';
...
Facility_tpRiskAdjustedReturn_title='Risk Adjusted Return';
Facility_tpCreditIncome_value=Facility_tpInterestIncome+Facility_tpCreditRelatedFee;
Facility_tpCreditIncome_title='Risk Adjusted Return - Income';
...
Facility_tpCreditRelatedFee_title='Risk Adjusted Return - Income - Credit Related Fee';
...
Facility_tpInterestIncome_title='Risk Adjusted Return - Income - Interest Income';
...
Facility_tpInternalExpectedLoss_title='Risk Adjusted Return - Other Expenses - Internal Expected Loss';
...
Facility_tpOperationalCosts_title='Risk Adjusted Return - Other Expenses - Operational Costs';
...
Facility_tpTax_title='Risk Adjusted Return - Other Expenses - Tax';
...
Facility_tpDirectLiquidityPremium_title='Risk Adjusted Return - Interest Expenses - Funds Transfer Pricing - Direct Liquidity Premium';
...
Facility_tpLiquiditySpreadRepaymentBullet_value=Facility_tpPrincipalLimit*Facility_tpOriginalTenor/12*(MatrixLookup('AAB_Parameters.xls',If(Facility_tpBaseCurrency=='EUR','LiquidityPremiumEUR',If(Facility_tpBaseCurrency=='GBP','LiquidityPremiumGBP',If(Facility_tpBaseCurrency=='USD','LiquidityPremiumUSD','LiquidityPremiumOther'))),MatrixLookup('LiquidityPremiumTenorLowerBound',Facility_tpOriginalTenor,1),Facility_tpFixedInterestPeriod)+(MatrixLookup('AAB_Parameters.xls',If(Facility_tpBaseCurrency=='EUR','LiquidityPremiumEUR',If(Facility_tpBaseCurrency=='GBP','LiquidityPremiumGBP',If(Facility_tpBaseCurrency=='USD','LiquidityPremiumUSD','LiquidityPremiumOther'))),MatrixLookup('LiquidityPremiumTenorUpperBound',Facility_tpOriginalTenor,1),Facility_tpFixedInterestPeriod)-MatrixLookup('AAB_Parameters.xls',If(Facility_tpBaseCurrency=='EUR','LiquidityPremiumEUR',If(Facility_tpBaseCurrency=='GBP','LiquidityPremiumGBP',If(Facility_tpBaseCurrency=='USD','LiquidityPremiumUSD','LiquidityPremiumOther'))),MatrixLookup('LiquidityPremiumTenorLowerBound',Facility_tpOriginalTenor,1),Facility_tpFixedInterestPeriod))*OnER((Facility_tpOriginalTenor-MatrixLookup('LiquidityPremiumTenorLowerBound',Facility_tpOriginalTenor,1))/(MatrixLookup('LiquidityPremiumTenorUpperBound',Facility_tpOriginalTenor,1)-MatrixLookup('LiquidityPremiumTenorLowerBound',Facility_tpOriginalTenor,1)),0));
...
Facility_tpLiquiditySpreadRepaymentLinear_value=SumFor(X,1+Facility_tpGracePeriodInPeriods,Facility_tpNumberOfPeriodsNoGrace,1,Facility_tpLinear*(X*Facility_tpConvertToMonths/Facility_tpRepaymentFrequencyLiqSpread)*(MatrixLookup('AAB_Parameters.xls',If(Facility_tpBaseCurrency=='EUR','LiquidityPremiumEUR',If(Facility_tpBaseCurrency=='GBP','LiquidityPremiumGBP',If(Facility_tpBaseCurrency=='USD','LiquidityPremiumUSD','LiquidityPremiumOther'))),MatrixLookup('LiquidityPremiumTenorLowerBound',X*12/Facility_tpRepaymentFrequency,1),Facility_tpFixedInterestPeriod)+(MatrixLookup('AAB_Parameters.xls',If(Facility_tpBaseCurrency=='EUR','LiquidityPremiumEUR',If(Facility_tpBaseCurrency=='GBP','LiquidityPremiumGBP',If(Facility_tpBaseCurrency=='USD','LiquidityPremiumUSD','LiquidityPremiumOther'))),MatrixLookup('LiquidityPremiumTenorUpperBound',X*12/Facility_tpRepaymentFrequency,1),Facility_tpFixedInterestPeriod)-MatrixLookup('AAB_Parameters.xls',If(Facility_tpBaseCurrency=='EUR','LiquidityPremiumEUR',If(Facility_tpBaseCurrency=='GBP','LiquidityPremiumGBP',If(Facility_tpBaseCurrency=='USD','LiquidityPremiumUSD','LiquidityPremiumOther'))),MatrixLookup('LiquidityPremiumTenorLowerBound',X*12/Facility_tpRepaymentFrequency,1),Facility_tpFixedInterestPeriod))*OnER((X*12/Facility_tpRepaymentFrequency-MatrixLookup('LiquidityPremiumTenorLowerBound',X*12/Facility_tpRepaymentFrequency,1))/(MatrixLookup('LiquidityPremiumTenorUpperBound',X*12/Facility_tpRepaymentFrequency,1)-MatrixLookup('LiquidityPremiumTenorLowerBound',X*12/Facility_tpRepaymentFrequency,1)),0)));
...
Facility_tpLiquiditySpreadRevolvingCredit_title='Liquidity Spread Withdrawal Scheme';
...
Facility_tpIndirectLiquidityCosts_title='Risk Adjusted Return - Interest Expenses - Indirect Liquidity Costs';
Facility_tpIndirectLiquidityCostsGeneral_value='';
...
Facility_tpSubordinatedDebtCapitalCharge_title='Risk Adjusted Return - Interest Expenses - Subordinated Debt Capital Charge';
...
Facility_tpEquityFundingAdjustment_title='Risk Adjusted Return - Interest Expenses - Equity Funding Adjustment';
...
Facility_tpEquityCapitalCharge_title='Regulatory Profit - Equity Capital Charge';
...
Facility_tpRWA_title='Risk Weighted Assets';
...
Facility_tpRGuaranteed_title='Risk Weighted Assets - Correlation Factor (R)';
...
Facility_tpR1Guaranteed_title='Risk Weighted Assets - Correlation Factor (R1)';
...
Facility_tpR2Guaranteed_title='Risk Weighted Assets - Correlation Factor (R2)';
Facility_tpbGuaranteed_value=OnER(.11852-.05478*LN(Facility_tpPDMoCGuaranteed)^2,NA);
Facility_tpbGuaranteed_title='Risk Weighted Assets - Maturity Adjustment Factor (b)';
...
Facility_tpMWRAGuaranteed_title='Risk Weighted Assets - MWRA Factor';
...
Facility_tpKGuaranteed_title='Risk Weighted Assets - Capital Requirement (K)';
Facility_tpRWGuaranteed_value=OnER(Facility_tpKGuaranteed*12.5*1.06,NA);
Facility_tpRWGuaranteed_title='Risk Weighted Assets - Risk Weight Factor (RW)';
...
Facility_tpDataExportedToForceSub1_value='';
Facility_tpDataExportedToForceSub1_title='RaRoRaC';
Facility_tpDataExportedToForceSub2_value='';
Facility_tpDataExportedToForceSub2_title='Return on Equity';
Facility_tpDataExportedToForceSub3_value='';
Facility_tpDataExportedToForceSub3_title='Economic Profit';
Facility_tpDataExportedToForceSub4_value='';
Facility_tpDataExportedToForceSub4_title='Regulatory Profit';
...
Q_MAP01_HULPVARIABELEN_visible=Q_MAP01.visible&&0;
...
Q_STATUS_FINAL_BY_value='';
Q_STATUS_FINAL_BY_title='Made final by (username), ';
Q_STATUS_FINAL_BY_NAME_value='';
...
Q_STATUS_STARTED_BY_value='';
Q_STATUS_STARTED_BY_title='Created by (username), ';
Q_STATUS_STARTED_BY_NAME_value='';
