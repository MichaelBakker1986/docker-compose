...
import api, { Context, Register, STRING_TYPE, WorkBook }                 from '../../lme-core/index'
import fllMath                                                           from '../../math/ffl-math'
import { RegisterPlainFFLDecorator, RegisterToFFL, RegisterToLMEParser } from '../../ffl/index'

api.addFunctions(fllMath)
api.registerParser(RegisterPlainFFLDecorator, new RegisterToLMEParser)

const context = new Context
const modelName = 'FFLMATH'
const wb = new WorkBook(context, null, null, { modelName })
