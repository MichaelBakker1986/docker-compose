...
angularApplication.controller('myController', function ($scope, $http, $interval) {
    ...
    var url = 'http://blfif-tv-tr03.finance.lab:8080/json/';
    ...
    $scope.initChart = function () {
        ...
        for (i = 0; i < dataList.length; i++) {
            ...
            serieData.push($scope.LME_MODEL[varName].value);
            categorieLabels.push($scope.LME_MODEL[varName].title);
        }
        var chart = {
            series: [{
                name: 'Jij',
