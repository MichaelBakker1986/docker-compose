            ...
            methods: {
                insertModelProperty: function(uuid, modelName, variableName, property, value) {
                    return new Promise(function(ok, fail) {
                        let sql = "INSERT INTO model_property (uuid,model_name,var,col,val) VALUES (?,?,?,?,?)";
                ...
                insertModelProperties: function(entries) {
                    return new Promise(function(ok, fail) {
                        ...
                        let sql = "INSERT INTO model_property (uuid,model_name,var,col,val) VALUES" + entries.map(a => {
                            return "('" + a.join("','") + "')"
