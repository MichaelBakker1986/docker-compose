...
When variable frciReasonDelivery is set to Kredietwijziging for column with end date 2016-12-31
...
When variable kvkiLegalSizeCriteriaClassification is set to Middelgroot for column with end date 2016-12-31
Then variable Q_STEP01 should have value Onvolledig ingevuld. for document
When the visible variables are exported as FrcRptKredietKleinFunctioneel2016.txt
