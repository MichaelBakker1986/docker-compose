...
import { JSVisitor, PropertiesAssembler, SolutionFacade } from '../../index'
import FinFormula                                         from '../../../ffl/FinFormula'

const ScreenDefinitionParser = {
	...
	parseData : function(json, workbook) {
		...
		JSVisitor.travelOne(data, null, function(keyArg, node, context) {
	...
	deParse   : function(rowId, workbook) {
		const screenSolution = SolutionFacade.createSolution(workbook.getSolutionName())
...
export default ScreenDefinitionParser